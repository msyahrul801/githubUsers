...
import com.dicoding.syahrul.adapter.FavoriteAdapter;
import com.dicoding.syahrul.databinding.ActivityFavoriteBinding;
...
public class FavoriteActivity extends AppCompatActivity implements LoadUserCallback {
    ...
    private final ArrayList<Users> favoriteList = new ArrayList<>();
